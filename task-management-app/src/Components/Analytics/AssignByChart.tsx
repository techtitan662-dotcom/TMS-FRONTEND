...
const AssignByChart: React.FC<AssignByChartProps> = ({
    categories,
    values,
    chartType,
    totalTasks,
        ...
        <BaseChartCard
            ...
            extraActions={
                <div className="flex items-center gap-3">
                    ...
                    <div className="text-xs text-gray-500 font-medium whitespace-nowrap">Total: {totalTasks}</div>
                </div>
            }
        >
